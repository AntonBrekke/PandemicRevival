...
data1 = np.loadtxt('rates_md_1.2000e-05_mphi_3.6000e-05_sin22th_2.5000e-13_y_1.9050e-04.dat')
x_grid1 = data1[:,0]
H1 = data1[:,1]
C_p_dd1 = data1[:,2]
C_dd_p1 = data1[:,3]
...
data2 = np.loadtxt('rates_md_2.0000e-05_mphi_6.0000e-05_sin22th_3.0000e-15_y_1.6022e-03.dat')
x_grid2 = data2[:,0]
H2 = data2[:,1]
C_p_dd2 = data2[:,2]
C_dd_p2 = data2[:,3]
