...
if True:
    ax1.fill_betweenx([-50, 0], 1e-5, 1e-3, color='white', alpha=1, zorder=-3)
    ...
    # plt.savefig(f'chemical_evo_{load_str.replace("./", "").replace(".dat","")}_final.pdf')
    plt.show()
elif False:
