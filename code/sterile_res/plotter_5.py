...
Y1 = np.linspace(-15.2, -12, 100)
X1 = [ip1(y) for y in Y1]
Y2 = np.linspace(-16.2, -15.2, 100)
X2 = [ip2(y) for y in Y2]
Y3 = np.linspace(-17.5, -16.22, 100)
...
ax.text(0.08, -8.8, r"$y = 10^{-6}$", color='forestgreen', fontsize=8, zorder=-1)
ax.text(0.161, -10.5, r"$10^{-5}$", color='forestgreen', fontsize=8, zorder=-1)
ax.text(0.161, -12.33, r"$10^{-4}$", color='forestgreen', fontsize=8, zorder=-1)
ax.text(0.161, -14.22, r"$10^{-3}$", color='forestgreen', fontsize=8, zorder=-1)
ax.text(0.161, -17.10, r"$10^{-2}$", color='forestgreen', fontsize=8, zorder=-1)
ax.text(1.6, -17.9, r"$10^{-1}$", color='forestgreen', fontsize=8, zorder=-1)

ax.text(0.65, -13.4, r"Ly-$\alpha$", color='darkorange', fontsize=10)
ax.text(0.65, -13.8, r"$\lambda_\mathrm{fs}$", color='darkorange', fontsize=10)
...
ax.text(0.27, -15.6, r"Ly-$\alpha$", color='#ff7b7b', fontsize=10, zorder=-4)
ax.text(0.27, -16.0, r"$r_\text{s}$", color='#ff7b7b', fontsize=10, zorder=-4)
# ax.text(0.4, -16.45, r"self-interactions", color='#A300CC', fontsize=10, rotation=-9)
ax.text(0.8, -17.7, r"self-interactions", color='#A300CC', fontsize=10, rotation=0)
...
ax.text(1.0, -13.45, "Athena", color='black', fontsize=8, rotation=-15)
...
ax.text(1.9, -8.75, "$m_\phi = 5 m_s$", color='black', fontsize=12, bbox=props)
